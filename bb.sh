...
global_variables() {
    ...
    # Blog title
    global_title="Levi Searches"
    # The typical subtitle for each blog
    global_description="A blog about anything that comes to my mind."
    # The public base URL for this blog
    global_url="https://levisearches.github.io/"

    # Your name
    global_author="Levi Searches"
    # You can use twitter or facebook or anything for global_author_url
    # global_author_url="http://twitter.com/example" 
    # Your email
    global_email="levisearches@proton.me"
    ...
    global_disqus_username="levi searches"


    # Blog generated files
    # index page of blog (it is usually good to use "index.html" here)
    index_file="index.html"
    number_of_index_articles="7"
    # global archive
...
create_includes() {
	...
	echo 'Consider making a <a href="https://getalby.com/p/levisearches">donation :)</a></div>'
        } >> ".footer.html"
    fi
}
